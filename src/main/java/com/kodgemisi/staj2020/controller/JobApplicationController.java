package com.kodgemisi.staj2020.controller;
...
import com.kodgemisi.staj2020.domain.validator.JobAppCustomValidator;
import com.kodgemisi.staj2020.service.FileStorage;
import com.kodgemisi.staj2020.service.JobApplicationService;
import com.kodgemisi.staj2020.service.JobListingService;
...
public class JobApplicationController {
	...
	public String postJobApp(@Valid JobApplicationDTO jobApplicationDTO, BindingResult bindingResult, @PathVariable("id") Long id,
		...
		if (bindingResult.hasErrors()) {
			...
			String url = "home/kodGemisi/staj2020/filestorage/" + file.getOriginalFilename();
